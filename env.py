...
# Custom continuous environment:
# ------------------------------
class ContinuousMazeEnv(gym.Env):
    """
    A continuous-state, discrete-action maze environment with danger zones for Project-B
    ...
    def render(self):
        ...
        pygame.draw.circle(self.screen, (0, 0, 255), agent_pix, 5)
...
# Run as a script: Use this to test/visualize the environment
# ----------------
